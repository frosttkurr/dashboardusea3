...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('dashboard.track.detail.update', [$id, $trackDetail->id])); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" type="text" id="keterangan" name="keterangan" rows="4" ><?php echo e($trackDetail->keterangan); ?></textarea>
                    </div>

                    
                    <input type="hidden" name="id_track" class="form-control" value="<?php echo e($id); ?>">
