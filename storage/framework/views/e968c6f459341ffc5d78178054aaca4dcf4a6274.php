                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('track')): ?>
                                ...
                                <a href="<?php echo e(route('admin.dashboard.track.detail.show', [$track->id, $detail->id])); ?>"><button type="button" class="mt-1 btn btn-secondary waves-effect waves-light">Detail</button></a>
