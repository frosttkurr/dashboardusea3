...
<?php $__env->startSection('title'); ?> Jenis Temuan  <?php $__env->stopSection(); ?>
...
<?php $__env->slot('title'); ?> Jenis Temuan <?php $__env->endSlot(); ?>
                        ...
                        <?php $__currentLoopData = $jenisTemuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $jenisTemuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('admin.dashboard.jenis-temuan.destroy', $jenisTemuan->id)); ?>" onclick="notificationBeforeDelete(event, this)">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboardusea3\resources\views/jenis-temuan/index.blade.php ENDPATH**/ ?>