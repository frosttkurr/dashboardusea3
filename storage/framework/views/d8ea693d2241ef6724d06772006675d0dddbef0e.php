...
<?php $__env->startSection('title'); ?> Ubah Laporan Nelayan <?php $__env->stopSection(); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="id_jenis_temuan" class="form-control <?php $__errorArgs = ['id_jenis_temuan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__errorArgs = ['id_jenis_temuan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" type="text" id="isi_laporan" name="isi_laporan" rows="4" ><?php echo e($laporanNelayan->isi_laporan); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($laporanNelayan->tanggal); ?>" type="date">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\dashboardusea3\resources\views/laporan-nelayan/edit.blade.php ENDPATH**/ ?>