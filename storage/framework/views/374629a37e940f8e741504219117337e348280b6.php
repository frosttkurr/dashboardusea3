...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.dashboard.biota.update', $biota->id)); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    <div class="mb-4">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($biota->nama_biota); ?>" type="text" id="nama_biota" name="nama_biota" placeholder="Nama Biota">
...
unset($__errorArgs, $__bag); ?>" data-trigger name="id_jenis_biota" id="choices-single-default" placeholder="Cari jenis biota">
                            <option selected="true" disabled="disabled">Pilih jenis biota</option>
                                <?php $__currentLoopData = $jenisBiotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenisBiota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                                   
                                    <option value="<?php echo e($jenisBiota->id); ?>" <?php if($jenisBiota->id == $biota->jenisBiota['id']): ?> selected <?php endif; ?>><?php echo e($jenisBiota->jenis_biota); ?></option>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($biota->deskripsi); ?>" type="text" id="deskripsi" name="deskripsi" placeholder="Deskripsi">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\dashboardusea3\resources\views/biota/edit.blade.php ENDPATH**/ ?>