                ...
                <div class="row">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('kondisi-perairan')): ?>
                        <div class="col-2 text-right">
                            <a href="<?php echo e(route('admin.dashboard.kondisi-perairan.create')); ?>"><button type="button" class="mt-1 btn btn-primary waves-effect waves-light">Tambah Data</button></a>
                        </div>
                    <?php endif; ?>
                </div>
                </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $kondisiPerairans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $kondisi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.dashboard.kondisi-perairan.edit', $kondisi->id)); ?>"><button type="button" class="mt-1 btn btn-warning waves-effect waves-light">Edit</button></a>
                                    <a href="<?php echo e(route('admin.dashboard.kondisi-perairan.destroy', $kondisi->id)); ?>" onclick="notificationBeforeDelete(event, this)">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboardusea3\resources\views/kondisi-perairan/index.blade.php ENDPATH**/ ?>